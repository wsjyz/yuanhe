 ...
 */
public class WeixinByUserUtils {

    protected static Logger logger = Logger.getLogger(WeixinByUserUtils.class);
    ...
    public String getAccessToken(){
        WeixinCorpAccessTokenBean tokenBean = WeixinByUserUtils.weixinCorpAccessTokenBean;
    ...
    public static void main(String[] args) {
        WeixinByUserUtils v = new WeixinByUserUtils();
        v.obtainAccessToken();
